 ...
 *     {@link java8fix.util.function.Function} (unary function from {@code T} to {@code R}),
 *     {@link java8fix.util.function.Consumer} (unary function from {@code T} to {@code void}),
 *     {@link java8fix.util.function.Predicate} (unary function from {@code T} to {@code boolean}),
 *     and {@link java8fix.util.function.Supplier} (nullary function to {@code R}).
 *     </li>
 *
 ...
 *     {@link java8fix.util.function.BiFunction} (binary function from {@code T} and
 *     {@code U} to {@code R}).
 *     </li>
 *
 *     <li>There are additional derived function shapes which extend the basic
 *     function shapes, including {@link java8fix.util.function.UnaryOperator}
 *     (extends {@code Function}) and {@link java8fix.util.function.BinaryOperator}
 ...
 *     prefix {@code ToXxx}, as in {@link java8fix.util.function.ToIntFunction}.
 *     Otherwise, type arguments are specialized left-to-right, as in
 *     {@link java8fix.util.function.DoubleConsumer}
 *     or {@link java8fix.util.function.ObjIntConsumer}.
 ...
 *     as in {@link java8fix.util.function.ObjIntConsumer}.)
 ...
 *     prefix may be left out (as in {@link java8fix.util.function.ObjIntConsumer}).
 *     </li>
 * </ul>
 *
 ...
 * @since 1.8
 */
package java8fix.util.function;
